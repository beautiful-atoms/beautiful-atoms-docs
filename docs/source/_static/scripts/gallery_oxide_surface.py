...
draw_plane(size=1000, location=(0, 0, min(slab111.positions[:, 2]) - slab111.size[0]),
...
slab111.render.lights['Default'].location = [
    com[0], com[1]-15, max(nano.positions[:, 2]) + 15]
slab111.render.camera.location = [
    com[0], com[1]-15, max(nano.positions[:, 2]) + 10]
